...
c iengv=1: engv process
      ...
      dimension fai0(nn,2*m),fai(nn,2*m,Lmax),faiold(nn,2*m)
...
c schmidt
      ...
      dimension aeigen(m,m),beigen(m,m),cc(m),fai2(nn,m*2)
c kinetic2      
...
c end select SH field ------------------------------------------------
     ...
     &           +hudown2(i,j)*fai0(j,inum+m)
      ...
      do ll=1,iLdim
         call mkgreen(ll,iLdim,nn,m,Lmax,IPIV,WORK,bufu,bufd
...
c preserve updated data ---------------------------------------
     ...
     &           +hkL0(i,k)*stfai(k,j+m,lite)
      ...
      do ll=1,iLdim
      call mkgreen(ll,lite,nn,m,Lmax,IPIV,WORK,bufu,bufd
     &            ,a,b,fai,gup,gdown,ginup,gindown)
...
c####################################################################
     ...
     &,fai,ihop1,ihop2,lsitex,lsitey,lsub)
      h=hold
      hin=hinold
      end if
...
c PIRG Triangular Lattice 8by8
     ...
     &,fai,ihop1,ihop2,lsitex,lsitey,lsub)
      ...
      dimension WORK2qp(3*Lmax-1),hgeed(Lmax,Lmax),hingeed(Lmax,Lmax)
...
c end engv dimension !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      open(unit=100,file="t2_1_Eng_vs_Engv2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=101,file="t2_1_Eng_u6_N36_m.txt"
     &,status='unknown')
      open(unit=102,file="t2_1_Dble_u6_N36_m.txt"
     &,status='unknown')
c nearest neighbor spin ccccccccccccccccccccccccccccc
      open(unit=103,file="t2_1_nnspin_sq_u6_N36_m.txt"
     &,status='unknown')
      open(unit=104,file="t2_1_nnspin_diag_u6_N36_m.txt"
     &,status='unknown')
      open(unit=105,file="t2_1_nnspin_tot_u6_N36_m.txt"
     &,status='unknown')
c kenetic energy cccccccccccccccccccccccccccccccccccccccccc
      open(unit=106,file="t2_1_nnhop_sq_u6_N36_m.txt"
     &,status='unknown')
      open(unit=107,file="t2_1_nnhop_diag_u6_N36_m.txt"
     &,status='unknown')
      open(unit=108,file="t2_1_nnhop_tot_u6_N36_m.txt"
     &,status='unknown')
     
     
c Omit lines from here ... 
c sq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=201,file="t2_1_Sq_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=202,file="t2_1_Sq_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=203,file="t2_1_Sq_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=204,file="t2_1_Sq_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=205,file="t2_1_Sq_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=206,file="t2_1_Sq_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=207,file="t2_1_Sq_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=208,file="t2_1_Sq_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=209,file="t2_1_Sq_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=210,file="t2_1_Sq_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=211,file="t2_1_Sq_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=212,file="t2_1_Sq_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=213,file="t2_1_Sq_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=214,file="t2_1_Sq_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=215,file="t2_1_Sq_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=216,file="t2_1_Sq_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=217,file="t2_1_Sq_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=218,file="t2_1_Sq_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=219,file="t2_1_Sq_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=220,file="t2_1_Sq_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=221,file="t2_1_Sq_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=222,file="t2_1_Sq_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=223,file="t2_1_Sq_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=224,file="t2_1_Sq_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=225,file="t2_1_Sq_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=226,file="t2_1_Sq_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=227,file="t2_1_Sq_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=228,file="t2_1_Sq_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=229,file="t2_1_Sq_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=230,file="t2_1_Sq_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=231,file="t2_1_Sq_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=232,file="t2_1_Sq_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=233,file="t2_1_Sq_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=234,file="t2_1_Sq_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=235,file="t2_1_Sq_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=236,file="t2_1_Sq_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=237,file="t2_1_Sq_37_u6_N36_m.txt"
     &,status='unknown')

c nq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=301,file="t2_1_Nq_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=302,file="t2_1_Nq_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=303,file="t2_1_Nq_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=304,file="t2_1_Nq_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=305,file="t2_1_Nq_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=306,file="t2_1_Nq_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=307,file="t2_1_Nq_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=308,file="t2_1_Nq_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=309,file="t2_1_Nq_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=310,file="t2_1_Nq_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=311,file="t2_1_Nq_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=312,file="t2_1_Nq_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=313,file="t2_1_Nq_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=314,file="t2_1_Nq_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=315,file="t2_1_Nq_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=316,file="t2_1_Nq_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=317,file="t2_1_Nq_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=318,file="t2_1_Nq_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=319,file="t2_1_Nq_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=320,file="t2_1_Nq_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=321,file="t2_1_Nq_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=322,file="t2_1_Nq_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=323,file="t2_1_Nq_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=324,file="t2_1_Nq_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=325,file="t2_1_Nq_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=326,file="t2_1_Nq_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=327,file="t2_1_Nq_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=328,file="t2_1_Nq_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=329,file="t2_1_Nq_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=330,file="t2_1_Nq_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=331,file="t2_1_Nq_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=332,file="t2_1_Nq_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=333,file="t2_1_Nq_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=334,file="t2_1_Nq_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=335,file="t2_1_Nq_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=336,file="t2_1_Nq_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=337,file="t2_1_Nq_37_u6_N36_m.txt"
     &,status='unknown')

c nk cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=401,file="t2_1_nk_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=402,file="t2_1_nk_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=403,file="t2_1_nk_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=404,file="t2_1_nk_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=405,file="t2_1_nk_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=406,file="t2_1_nk_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=407,file="t2_1_nk_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=408,file="t2_1_nk_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=409,file="t2_1_nk_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=410,file="t2_1_nk_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=411,file="t2_1_nk_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=412,file="t2_1_nk_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=413,file="t2_1_nk_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=414,file="t2_1_nk_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=415,file="t2_1_nk_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=416,file="t2_1_nk_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=417,file="t2_1_nk_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=418,file="t2_1_nk_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=419,file="t2_1_nk_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=420,file="t2_1_nk_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=421,file="t2_1_nk_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=422,file="t2_1_nk_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=423,file="t2_1_nk_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=424,file="t2_1_nk_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=425,file="t2_1_nk_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=426,file="t2_1_nk_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=427,file="t2_1_nk_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=428,file="t2_1_nk_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=429,file="t2_1_nk_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=430,file="t2_1_nk_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=431,file="t2_1_nk_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=432,file="t2_1_nk_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=433,file="t2_1_nk_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=434,file="t2_1_nk_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=435,file="t2_1_nk_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=436,file="t2_1_nk_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=437,file="t2_1_nk_37_u6_N36_m.txt"
     &,status='unknown')
c ... to here when finding only real space physical quantities.
      ...
      open(unit=100,file="QP_S0_t2_1_Eng_vs_Engv2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=101,file="QP_S0_t2_1_Eng_u6_N36_m.txt"
     &,status='unknown')
      open(unit=102,file="QP_S0_t2_1_Dble_u6_N36_m.txt"
     &,status='unknown')
c nearest neighbor spin ccccccccccccccccccccccccccccc
      open(unit=103,file="QP_S0_t2_1_nnspin_sq_u6_N36_m.txt"
     &,status='unknown')
      open(unit=104,file="QP_S0_t2_1_nnspin_diag_u6_N36_m.txt"
     &,status='unknown')
      open(unit=105,file="QP_S0_t2_1_nnspin_tot_u6_N36_m.txt"
     &,status='unknown')
c kenetic energy cccccccccccccccccccccccccccccccccccccccccc
      open(unit=106,file="QP_S0_t2_1_nnhop_sq_u6_N36_m.txt"
     &,status='unknown')
      open(unit=107,file="QP_S0_t2_1_nnhop_diag_u6_N36_m.txt"
     &,status='unknown')
      open(unit=108,file="QP_S0_t2_1_nnhop_tot_u6_N36_m.txt"
     &,status='unknown')
     

c Omit lines from here ... 
c sq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=201,file="QP_S0_t2_1_Sq_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=202,file="QP_S0_t2_1_Sq_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=203,file="QP_S0_t2_1_Sq_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=204,file="QP_S0_t2_1_Sq_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=205,file="QP_S0_t2_1_Sq_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=206,file="QP_S0_t2_1_Sq_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=207,file="QP_S0_t2_1_Sq_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=208,file="QP_S0_t2_1_Sq_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=209,file="QP_S0_t2_1_Sq_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=210,file="QP_S0_t2_1_Sq_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=211,file="QP_S0_t2_1_Sq_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=212,file="QP_S0_t2_1_Sq_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=213,file="QP_S0_t2_1_Sq_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=214,file="QP_S0_t2_1_Sq_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=215,file="QP_S0_t2_1_Sq_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=216,file="QP_S0_t2_1_Sq_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=217,file="QP_S0_t2_1_Sq_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=218,file="QP_S0_t2_1_Sq_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=219,file="QP_S0_t2_1_Sq_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=220,file="QP_S0_t2_1_Sq_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=221,file="QP_S0_t2_1_Sq_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=222,file="QP_S0_t2_1_Sq_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=223,file="QP_S0_t2_1_Sq_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=224,file="QP_S0_t2_1_Sq_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=225,file="QP_S0_t2_1_Sq_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=226,file="QP_S0_t2_1_Sq_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=227,file="QP_S0_t2_1_Sq_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=228,file="QP_S0_t2_1_Sq_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=229,file="QP_S0_t2_1_Sq_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=230,file="QP_S0_t2_1_Sq_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=231,file="QP_S0_t2_1_Sq_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=232,file="QP_S0_t2_1_Sq_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=233,file="QP_S0_t2_1_Sq_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=234,file="QP_S0_t2_1_Sq_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=235,file="QP_S0_t2_1_Sq_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=236,file="QP_S0_t2_1_Sq_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=237,file="QP_S0_t2_1_Sq_37_u6_N36_m.txt"
     &,status='unknown')

c nq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=301,file="QP_S0_t2_1_Nq_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=302,file="QP_S0_t2_1_Nq_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=303,file="QP_S0_t2_1_Nq_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=304,file="QP_S0_t2_1_Nq_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=305,file="QP_S0_t2_1_Nq_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=306,file="QP_S0_t2_1_Nq_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=307,file="QP_S0_t2_1_Nq_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=308,file="QP_S0_t2_1_Nq_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=309,file="QP_S0_t2_1_Nq_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=310,file="QP_S0_t2_1_Nq_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=311,file="QP_S0_t2_1_Nq_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=312,file="QP_S0_t2_1_Nq_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=313,file="QP_S0_t2_1_Nq_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=314,file="QP_S0_t2_1_Nq_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=315,file="QP_S0_t2_1_Nq_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=316,file="QP_S0_t2_1_Nq_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=317,file="QP_S0_t2_1_Nq_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=318,file="QP_S0_t2_1_Nq_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=319,file="QP_S0_t2_1_Nq_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=320,file="QP_S0_t2_1_Nq_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=321,file="QP_S0_t2_1_Nq_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=322,file="QP_S0_t2_1_Nq_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=323,file="QP_S0_t2_1_Nq_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=324,file="QP_S0_t2_1_Nq_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=325,file="QP_S0_t2_1_Nq_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=326,file="QP_S0_t2_1_Nq_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=327,file="QP_S0_t2_1_Nq_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=328,file="QP_S0_t2_1_Nq_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=329,file="QP_S0_t2_1_Nq_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=330,file="QP_S0_t2_1_Nq_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=331,file="QP_S0_t2_1_Nq_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=332,file="QP_S0_t2_1_Nq_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=333,file="QP_S0_t2_1_Nq_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=334,file="QP_S0_t2_1_Nq_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=335,file="QP_S0_t2_1_Nq_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=336,file="QP_S0_t2_1_Nq_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=337,file="QP_S0_t2_1_Nq_37_u6_N36_m.txt"
     &,status='unknown')

c nk cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=401,file="QP_S0_t2_1_nk_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=402,file="QP_S0_t2_1_nk_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=403,file="QP_S0_t2_1_nk_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=404,file="QP_S0_t2_1_nk_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=405,file="QP_S0_t2_1_nk_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=406,file="QP_S0_t2_1_nk_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=407,file="QP_S0_t2_1_nk_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=408,file="QP_S0_t2_1_nk_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=409,file="QP_S0_t2_1_nk_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=410,file="QP_S0_t2_1_nk_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=411,file="QP_S0_t2_1_nk_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=412,file="QP_S0_t2_1_nk_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=413,file="QP_S0_t2_1_nk_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=414,file="QP_S0_t2_1_nk_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=415,file="QP_S0_t2_1_nk_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=416,file="QP_S0_t2_1_nk_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=417,file="QP_S0_t2_1_nk_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=418,file="QP_S0_t2_1_nk_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=419,file="QP_S0_t2_1_nk_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=420,file="QP_S0_t2_1_nk_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=421,file="QP_S0_t2_1_nk_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=422,file="QP_S0_t2_1_nk_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=423,file="QP_S0_t2_1_nk_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=424,file="QP_S0_t2_1_nk_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=425,file="QP_S0_t2_1_nk_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=426,file="QP_S0_t2_1_nk_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=427,file="QP_S0_t2_1_nk_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=428,file="QP_S0_t2_1_nk_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=429,file="QP_S0_t2_1_nk_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=430,file="QP_S0_t2_1_nk_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=431,file="QP_S0_t2_1_nk_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=432,file="QP_S0_t2_1_nk_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=433,file="QP_S0_t2_1_nk_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=434,file="QP_S0_t2_1_nk_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=435,file="QP_S0_t2_1_nk_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=436,file="QP_S0_t2_1_nk_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=437,file="QP_S0_t2_1_nk_37_u6_N36_m.txt"
     &,status='unknown')
c ... to here when finding only real space physical quantities.
      ...
      open(unit=100,file="QP_S1_t2_1_Eng_vs_Engv2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=101,file="QP_S1_t2_1_Eng_u6_N36_m.txt"
     &,status='unknown')
      open(unit=102,file="QP_S1_t2_1_Dble_u6_N36_m.txt"
     &,status='unknown')
c nearest neighbor spin ccccccccccccccccccccccccccccc
      open(unit=103,file="QP_S1_t2_1_nnspin_sq_u6_N36_m.txt"
     &,status='unknown')
      open(unit=104,file="QP_S1_t2_1_nnspin_diag_u6_N36_m.txt"
     &,status='unknown')
      open(unit=105,file="QP_S1_t2_1_nnspin_tot_u6_N36_m.txt"
     &,status='unknown')
c kenetic energy cccccccccccccccccccccccccccccccccccccccccc
      open(unit=106,file="QP_S1_t2_1_nnhop_sq_u6_N36_m.txt"
     &,status='unknown')
      open(unit=107,file="QP_S1_t2_1_nnhop_diag_u6_N36_m.txt"
     &,status='unknown')
      open(unit=108,file="QP_S1_t2_1_nnhop_tot_u6_N36_m.txt"
     &,status='unknown')
     
     
c Omit lines from here ... 
c sq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=201,file="QP_S1_t2_1_Sq_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=202,file="QP_S1_t2_1_Sq_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=203,file="QP_S1_t2_1_Sq_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=204,file="QP_S1_t2_1_Sq_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=205,file="QP_S1_t2_1_Sq_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=206,file="QP_S1_t2_1_Sq_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=207,file="QP_S1_t2_1_Sq_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=208,file="QP_S1_t2_1_Sq_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=209,file="QP_S1_t2_1_Sq_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=210,file="QP_S1_t2_1_Sq_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=211,file="QP_S1_t2_1_Sq_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=212,file="QP_S1_t2_1_Sq_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=213,file="QP_S1_t2_1_Sq_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=214,file="QP_S1_t2_1_Sq_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=215,file="QP_S1_t2_1_Sq_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=216,file="QP_S1_t2_1_Sq_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=217,file="QP_S1_t2_1_Sq_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=218,file="QP_S1_t2_1_Sq_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=219,file="QP_S1_t2_1_Sq_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=220,file="QP_S1_t2_1_Sq_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=221,file="QP_S1_t2_1_Sq_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=222,file="QP_S1_t2_1_Sq_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=223,file="QP_S1_t2_1_Sq_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=224,file="QP_S1_t2_1_Sq_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=225,file="QP_S1_t2_1_Sq_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=226,file="QP_S1_t2_1_Sq_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=227,file="QP_S1_t2_1_Sq_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=228,file="QP_S1_t2_1_Sq_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=229,file="QP_S1_t2_1_Sq_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=230,file="QP_S1_t2_1_Sq_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=231,file="QP_S1_t2_1_Sq_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=232,file="QP_S1_t2_1_Sq_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=233,file="QP_S1_t2_1_Sq_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=234,file="QP_S1_t2_1_Sq_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=235,file="QP_S1_t2_1_Sq_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=236,file="QP_S1_t2_1_Sq_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=237,file="QP_S1_t2_1_Sq_37_u6_N36_m.txt"
     &,status='unknown')

c nq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=301,file="QP_S1_t2_1_Nq_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=302,file="QP_S1_t2_1_Nq_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=303,file="QP_S1_t2_1_Nq_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=304,file="QP_S1_t2_1_Nq_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=305,file="QP_S1_t2_1_Nq_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=306,file="QP_S1_t2_1_Nq_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=307,file="QP_S1_t2_1_Nq_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=308,file="QP_S1_t2_1_Nq_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=309,file="QP_S1_t2_1_Nq_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=310,file="QP_S1_t2_1_Nq_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=311,file="QP_S1_t2_1_Nq_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=312,file="QP_S1_t2_1_Nq_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=313,file="QP_S1_t2_1_Nq_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=314,file="QP_S1_t2_1_Nq_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=315,file="QP_S1_t2_1_Nq_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=316,file="QP_S1_t2_1_Nq_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=317,file="QP_S1_t2_1_Nq_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=318,file="QP_S1_t2_1_Nq_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=319,file="QP_S1_t2_1_Nq_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=320,file="QP_S1_t2_1_Nq_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=321,file="QP_S1_t2_1_Nq_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=322,file="QP_S1_t2_1_Nq_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=323,file="QP_S1_t2_1_Nq_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=324,file="QP_S1_t2_1_Nq_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=325,file="QP_S1_t2_1_Nq_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=326,file="QP_S1_t2_1_Nq_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=327,file="QP_S1_t2_1_Nq_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=328,file="QP_S1_t2_1_Nq_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=329,file="QP_S1_t2_1_Nq_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=330,file="QP_S1_t2_1_Nq_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=331,file="QP_S1_t2_1_Nq_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=332,file="QP_S1_t2_1_Nq_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=333,file="QP_S1_t2_1_Nq_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=334,file="QP_S1_t2_1_Nq_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=335,file="QP_S1_t2_1_Nq_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=336,file="QP_S1_t2_1_Nq_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=337,file="QP_S1_t2_1_Nq_37_u6_N36_m.txt"
     &,status='unknown')

c nk cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(unit=401,file="QP_S1_t2_1_nk_1_u6_N36_m.txt"
     &,status='unknown')
      open(unit=402,file="QP_S1_t2_1_nk_2_u6_N36_m.txt"
     &,status='unknown')
      open(unit=403,file="QP_S1_t2_1_nk_3_u6_N36_m.txt"
     &,status='unknown')
      open(unit=404,file="QP_S1_t2_1_nk_4_u6_N36_m.txt"
     &,status='unknown')
      open(unit=405,file="QP_S1_t2_1_nk_5_u6_N36_m.txt"
     &,status='unknown')
      open(unit=406,file="QP_S1_t2_1_nk_6_u6_N36_m.txt"
     &,status='unknown')
      open(unit=407,file="QP_S1_t2_1_nk_7_u6_N36_m.txt"
     &,status='unknown')
      open(unit=408,file="QP_S1_t2_1_nk_8_u6_N36_m.txt"
     &,status='unknown')
      open(unit=409,file="QP_S1_t2_1_nk_9_u6_N36_m.txt"
     &,status='unknown')
      open(unit=410,file="QP_S1_t2_1_nk_10_u6_N36_m.txt"
     &,status='unknown')
      open(unit=411,file="QP_S1_t2_1_nk_11_u6_N36_m.txt"
     &,status='unknown')
      open(unit=412,file="QP_S1_t2_1_nk_12_u6_N36_m.txt"
     &,status='unknown')
      open(unit=413,file="QP_S1_t2_1_nk_13_u6_N36_m.txt"
     &,status='unknown')
      open(unit=414,file="QP_S1_t2_1_nk_14_u6_N36_m.txt"
     &,status='unknown')
      open(unit=415,file="QP_S1_t2_1_nk_15_u6_N36_m.txt"
     &,status='unknown')
      open(unit=416,file="QP_S1_t2_1_nk_16_u6_N36_m.txt"
     &,status='unknown')
      open(unit=417,file="QP_S1_t2_1_nk_17_u6_N36_m.txt"
     &,status='unknown')
      open(unit=418,file="QP_S1_t2_1_nk_18_u6_N36_m.txt"
     &,status='unknown')
      open(unit=419,file="QP_S1_t2_1_nk_19_u6_N36_m.txt"
     &,status='unknown')
      open(unit=420,file="QP_S1_t2_1_nk_20_u6_N36_m.txt"
     &,status='unknown')
      open(unit=421,file="QP_S1_t2_1_nk_21_u6_N36_m.txt"
     &,status='unknown')
      open(unit=422,file="QP_S1_t2_1_nk_22_u6_N36_m.txt"
     &,status='unknown')
      open(unit=423,file="QP_S1_t2_1_nk_23_u6_N36_m.txt"
     &,status='unknown')
      open(unit=424,file="QP_S1_t2_1_nk_24_u6_N36_m.txt"
     &,status='unknown')
      open(unit=425,file="QP_S1_t2_1_nk_25_u6_N36_m.txt"
     &,status='unknown')
      open(unit=426,file="QP_S1_t2_1_nk_26_u6_N36_m.txt"
     &,status='unknown')
      open(unit=427,file="QP_S1_t2_1_nk_27_u6_N36_m.txt"
     &,status='unknown')
      open(unit=428,file="QP_S1_t2_1_nk_28_u6_N36_m.txt"
     &,status='unknown')
      open(unit=429,file="QP_S1_t2_1_nk_29_u6_N36_m.txt"
     &,status='unknown')
      open(unit=430,file="QP_S1_t2_1_nk_30_u6_N36_m.txt"
     &,status='unknown')
      open(unit=431,file="QP_S1_t2_1_nk_31_u6_N36_m.txt"
     &,status='unknown')
      open(unit=432,file="QP_S1_t2_1_nk_32_u6_N36_m.txt"
     &,status='unknown')
      open(unit=433,file="QP_S1_t2_1_nk_33_u6_N36_m.txt"
     &,status='unknown')
      open(unit=434,file="QP_S1_t2_1_nk_34_u6_N36_m.txt"
     &,status='unknown')
      open(unit=435,file="QP_S1_t2_1_nk_35_u6_N36_m.txt"
     &,status='unknown')
      open(unit=436,file="QP_S1_t2_1_nk_36_u6_N36_m.txt"
     &,status='unknown')
      open(unit=437,file="QP_S1_t2_1_nk_37_u6_N36_m.txt"
     &,status='unknown')
c ... to here when finding only real space physical quantities.
...
c subspace EXT --------------------------------------------------
      ...
      LWORK=3*iLdim-1
      call geedv(Lmax,iLdim,hqp,hinqp
     &,hgeed,hingeed,deigen,eigen,WORK2qp,LWORK)
      pirgeng=eigen
      hinre=0.0d0
      do lr=1,iLdim
         do ll=1,lr
...
c additional alignment -------------------------------------------
      ...
      hnq=0.0d0
c ----------------------------------------------------------
cc!$omp parallel do private(cweight)
cc!reduction(+:hh2,hdble,hkin1,hkin2,hkin3,hssnn1,hssnn2,hssnn3,tsq,hnk,hsq,hnq) 
      do lr=1,iLdim
         do ll=1,lr
      if(ll.ne.lr) then
...
c Omit lines from here ... 
     ...
     &                          .or.lky(k).eq.ny/2) then
      ...
      write(80,*) 'particle number',a*2.0d0/dble(nn)
c ... to here when finding only real space physical quantities.
...
c         resetd=0.0d0
c         do i=1,nn
c            resetu=resetu+fai(i,j,lite)**2
c            resetd=resetd+fai(i,j+m,lite)**2
c         end do
c         do i=1,nn
c            fai(i,j,lite)=fai(i,j,lite)/dsqrt(resetu)
c            fai(i,j+m,lite)=fai(i,j+m,lite)/dsqrt(resetd)
c         end do
c      end do
...
c         b(inum,jnum)=0.0d0
c         do i=1,nn
c            a(inum,jnum)=a(inum,jnum)
c     &     +fai(i,inum,lite)*fai(i,jnum,lite)
c            b(inum,jnum)=b(inum,jnum)
c     &     +fai(i,inum+m,lite)*fai(i,jnum+m,lite)
c         end do
c      end do
c      end do
c
...
ccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine mkgreen(ll,lr,nn,m,Lmax,IPIV,WORK,bufu,bufd
     &,a,b,fai,gup,gdown,ginup,gindown)
      implicit real*8(a-h,o-z)
      implicit integer*4(i-n) 
      character*1 UPLO 
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine geedv(Lmax,iLdim,h,hin
     &,hgeed,hingeed,deigen,eigen,WORK2qp,LWORK)
      implicit real*8(a-h,o-z)
      implicit integer*4(i-n)
      character*1 JOBZ 
      ...
      dimension h(Lmax,Lmax),hin(Lmax,Lmax)
      dimension hgeed(iLdim,iLdim),hingeed(iLdim,iLdim)
      dimension deigen(iLdim),WORK2qp(LWORK)
