...
c PIRG Checkerboard Lattice 20site
...
c kenetic energy cccccccccccccccccccccccccccccccccccccccccc
     ...
     &,status='unknown')
      ...
      open(unit=109,file="t2_1_Dxx_1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=110,file="t2_1_Dxx_2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=111,file="t2_1_Dyy_1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=112,file="t2_1_Dyy_2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=113,file="t2_1_Dxy_1_u6_N20_m.txt"
     &,status='unknown')
     
      open(unit=114,file="t2_1_C-VBC_1_u6_N20_m.txt"
     &,status='unknown')
      
      open(unit=115,file="t2_1_PLA0-tot_u6_N20_m.txt"
     &,status='unknown')
      open(unit=116,file="t2_1_PLA0-0_u6_N20_m.txt"
     &,status='unknown')
      open(unit=117,file="t2_1_PLA0-1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=118,file="t2_1_PLA0-2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=119,file="t2_1_PLA0-3_u6_N20_m.txt"
     &,status='unknown')
      open(unit=120,file="t2_1_PLA0-4_u6_N20_m.txt"
     &,status='unknown')
      open(unit=121,file="t2_1_PLA0-5_u6_N20_m.txt"
     &,status='unknown')
     
      open(unit=122,file="t2_1_DIAG0-tot_u6_N20_m.txt"
     &,status='unknown')
      open(unit=123,file="t2_1_DIAG0-0_u6_N20_m.txt"
     &,status='unknown')
      open(unit=124,file="t2_1_DIAG0-1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=125,file="t2_1_DIAG0-2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=126,file="t2_1_DIAG0-3_u6_N20_m.txt"
     &,status='unknown')
      open(unit=127,file="t2_1_DIAG0-4_u6_N20_m.txt"
     &,status='unknown')
      open(unit=128,file="t2_1_DIAG0-5_u6_N20_m.txt"
     &,status='unknown')

c Omit lines from here ... 
cc sq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=201,file="t2_1_Sq_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=202,file="t2_1_Sq_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=203,file="t2_1_Sq_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=204,file="t2_1_Sq_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=205,file="t2_1_Sq_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=206,file="t2_1_Sq_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=207,file="t2_1_Sq_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=208,file="t2_1_Sq_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=209,file="t2_1_Sq_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=210,file="t2_1_Sq_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=211,file="t2_1_Sq_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=212,file="t2_1_Sq_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=213,file="t2_1_Sq_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=214,file="t2_1_Sq_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=215,file="t2_1_Sq_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=216,file="t2_1_Sq_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=217,file="t2_1_Sq_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=218,file="t2_1_Sq_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=219,file="t2_1_Sq_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=220,file="t2_1_Sq_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=221,file="t2_1_Sq_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=222,file="t2_1_Sq_min_11_u6_N20_m.txt"
c     &,status='unknown')
c
cc nq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=301,file="t2_1_Nq_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=302,file="t2_1_Nq_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=303,file="t2_1_Nq_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=304,file="t2_1_Nq_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=305,file="t2_1_Nq_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=306,file="t2_1_Nq_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=307,file="t2_1_Nq_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=308,file="t2_1_Nq_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=309,file="t2_1_Nq_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=310,file="t2_1_Nq_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=311,file="t2_1_Nq_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=312,file="t2_1_Nq_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=313,file="t2_1_Nq_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=314,file="t2_1_Nq_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=315,file="t2_1_Nq_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=316,file="t2_1_Nq_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=317,file="t2_1_Nq_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=318,file="t2_1_Nq_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=319,file="t2_1_Nq_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=320,file="t2_1_Nq_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=321,file="t2_1_Nq_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=322,file="t2_1_Nq_min_11_u6_N20_m.txt"
c     &,status='unknown')
c
cc nk cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=401,file="t2_1_nk_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=402,file="t2_1_nk_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=403,file="t2_1_nk_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=404,file="t2_1_nk_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=405,file="t2_1_nk_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=406,file="t2_1_nk_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=407,file="t2_1_nk_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=408,file="t2_1_nk_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=409,file="t2_1_nk_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=410,file="t2_1_nk_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=411,file="t2_1_nk_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=412,file="t2_1_nk_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=413,file="t2_1_nk_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=414,file="t2_1_nk_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=415,file="t2_1_nk_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=416,file="t2_1_nk_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=417,file="t2_1_nk_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=418,file="t2_1_nk_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=419,file="t2_1_nk_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=420,file="t2_1_nk_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=421,file="t2_1_nk_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=422,file="t2_1_nk_min_11_u6_N20_m.txt"
c     &,status='unknown')
c ... to here when finding only real space physical quantities.
...
c kenetic energy cccccccccccccccccccccccccccccccccccccccccc
     ...
     &,status='unknown')
      ...
      open(unit=109,file="QP_S0_t2_1_Dxx_1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=110,file="QP_S0_t2_1_Dxx_2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=111,file="QP_S0_t2_1_Dyy_1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=112,file="QP_S0_t2_1_Dyy_2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=113,file="QP_S0_t2_1_Dxy_1_u6_N20_m.txt"
     &,status='unknown')
     
      open(unit=114,file="QP_S0_t2_1_C-VBC_1_u6_N20_m.txt"
     &,status='unknown')
      
      open(unit=115,file="QP_S0_t2_1_PLA0-tot_u6_N20_m.txt"
     &,status='unknown')
      open(unit=116,file="QP_S0_t2_1_PLA0-0_u6_N20_m.txt"
     &,status='unknown')
      open(unit=117,file="QP_S0_t2_1_PLA0-1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=118,file="QP_S0_t2_1_PLA0-2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=119,file="QP_S0_t2_1_PLA0-3_u6_N20_m.txt"
     &,status='unknown')
      open(unit=120,file="QP_S0_t2_1_PLA0-4_u6_N20_m.txt"
     &,status='unknown')
      open(unit=121,file="QP_S0_t2_1_PLA0-5_u6_N20_m.txt"
     &,status='unknown')
     
      open(unit=122,file="QP_S0_t2_1_DIAG0-tot_u6_N20_m.txt"
     &,status='unknown')
      open(unit=123,file="QP_S0_t2_1_DIAG0-0_u6_N20_m.txt"
     &,status='unknown')
      open(unit=124,file="QP_S0_t2_1_DIAG0-1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=125,file="QP_S0_t2_1_DIAG0-2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=126,file="QP_S0_t2_1_DIAG0-3_u6_N20_m.txt"
     &,status='unknown')
      open(unit=127,file="QP_S0_t2_1_DIAG0-4_u6_N20_m.txt"
     &,status='unknown')
      open(unit=128,file="QP_S0_t2_1_DIAG0-5_u6_N20_m.txt"
     &,status='unknown')

c Omit lines from here ... 
cc sq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=201,file="QP_S0_t2_1_Sq_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=202,file="QP_S0_t2_1_Sq_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=203,file="QP_S0_t2_1_Sq_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=204,file="QP_S0_t2_1_Sq_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=205,file="QP_S0_t2_1_Sq_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=206,file="QP_S0_t2_1_Sq_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=207,file="QP_S0_t2_1_Sq_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=208,file="QP_S0_t2_1_Sq_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=209,file="QP_S0_t2_1_Sq_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=210,file="QP_S0_t2_1_Sq_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=211,file="QP_S0_t2_1_Sq_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=212,file="QP_S0_t2_1_Sq_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=213,file="QP_S0_t2_1_Sq_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=214,file="QP_S0_t2_1_Sq_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=215,file="QP_S0_t2_1_Sq_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=216,file="QP_S0_t2_1_Sq_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=217,file="QP_S0_t2_1_Sq_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=218,file="QP_S0_t2_1_Sq_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=219,file="QP_S0_t2_1_Sq_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=220,file="QP_S0_t2_1_Sq_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=221,file="QP_S0_t2_1_Sq_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=222,file="QP_S0_t2_1_Sq_min_11_u6_N20_m.txt"
c     &,status='unknown')
c
cc nq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=301,file="QP_S0_t2_1_Nq_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=302,file="QP_S0_t2_1_Nq_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=303,file="QP_S0_t2_1_Nq_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=304,file="QP_S0_t2_1_Nq_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=305,file="QP_S0_t2_1_Nq_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=306,file="QP_S0_t2_1_Nq_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=307,file="QP_S0_t2_1_Nq_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=308,file="QP_S0_t2_1_Nq_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=309,file="QP_S0_t2_1_Nq_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=310,file="QP_S0_t2_1_Nq_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=311,file="QP_S0_t2_1_Nq_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=312,file="QP_S0_t2_1_Nq_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=313,file="QP_S0_t2_1_Nq_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=314,file="QP_S0_t2_1_Nq_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=315,file="QP_S0_t2_1_Nq_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=316,file="QP_S0_t2_1_Nq_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=317,file="QP_S0_t2_1_Nq_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=318,file="QP_S0_t2_1_Nq_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=319,file="QP_S0_t2_1_Nq_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=320,file="QP_S0_t2_1_Nq_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=321,file="QP_S0_t2_1_Nq_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=322,file="QP_S0_t2_1_Nq_min_11_u6_N20_m.txt"
c     &,status='unknown')
c
cc nk cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=401,file="QP_S0_t2_1_nk_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=402,file="QP_S0_t2_1_nk_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=403,file="QP_S0_t2_1_nk_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=404,file="QP_S0_t2_1_nk_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=405,file="QP_S0_t2_1_nk_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=406,file="QP_S0_t2_1_nk_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=407,file="QP_S0_t2_1_nk_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=408,file="QP_S0_t2_1_nk_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=409,file="QP_S0_t2_1_nk_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=410,file="QP_S0_t2_1_nk_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=411,file="QP_S0_t2_1_nk_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=412,file="QP_S0_t2_1_nk_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=413,file="QP_S0_t2_1_nk_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=414,file="QP_S0_t2_1_nk_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=415,file="QP_S0_t2_1_nk_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=416,file="QP_S0_t2_1_nk_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=417,file="QP_S0_t2_1_nk_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=418,file="QP_S0_t2_1_nk_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=419,file="QP_S0_t2_1_nk_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=420,file="QP_S0_t2_1_nk_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=421,file="QP_S0_t2_1_nk_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=422,file="QP_S0_t2_1_nk_min_11_u6_N20_m.txt"
c     &,status='unknown')
c ... to here when finding only real space physical quantities.
...
c kenetic energy cccccccccccccccccccccccccccccccccccccccccc
     ...
     &,status='unknown')
      ...
      open(unit=109,file="QP_S1_t2_1_Dxx_1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=110,file="QP_S1_t2_1_Dxx_2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=111,file="QP_S1_t2_1_Dyy_1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=112,file="QP_S1_t2_1_Dyy_2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=113,file="QP_S1_t2_1_Dxy_1_u6_N20_m.txt"
     &,status='unknown')
     
      open(unit=114,file="QP_S1_t2_1_C-VBC_1_u6_N20_m.txt"
     &,status='unknown')
      
      open(unit=115,file="QP_S1_t2_1_PLA0-tot_u6_N20_m.txt"
     &,status='unknown')
      open(unit=116,file="QP_S1_t2_1_PLA0-0_u6_N20_m.txt"
     &,status='unknown')
      open(unit=117,file="QP_S1_t2_1_PLA0-1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=118,file="QP_S1_t2_1_PLA0-2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=119,file="QP_S1_t2_1_PLA0-3_u6_N20_m.txt"
     &,status='unknown')
      open(unit=120,file="QP_S1_t2_1_PLA0-4_u6_N20_m.txt"
     &,status='unknown')
      open(unit=121,file="QP_S1_t2_1_PLA0-5_u6_N20_m.txt"
     &,status='unknown')
     
      open(unit=122,file="QP_S1_t2_1_DIAG0-tot_u6_N20_m.txt"
     &,status='unknown')
      open(unit=123,file="QP_S1_t2_1_DIAG0-0_u6_N20_m.txt"
     &,status='unknown')
      open(unit=124,file="QP_S1_t2_1_DIAG0-1_u6_N20_m.txt"
     &,status='unknown')
      open(unit=125,file="QP_S1_t2_1_DIAG0-2_u6_N20_m.txt"
     &,status='unknown')
      open(unit=126,file="QP_S1_t2_1_DIAG0-3_u6_N20_m.txt"
     &,status='unknown')
      open(unit=127,file="QP_S1_t2_1_DIAG0-4_u6_N20_m.txt"
     &,status='unknown')
      open(unit=128,file="QP_S1_t2_1_DIAG0-5_u6_N20_m.txt"
     &,status='unknown')
     
c Omit lines from here ... 
cc sq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=201,file="QP_S1_t2_1_Sq_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=202,file="QP_S1_t2_1_Sq_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=203,file="QP_S1_t2_1_Sq_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=204,file="QP_S1_t2_1_Sq_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=205,file="QP_S1_t2_1_Sq_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=206,file="QP_S1_t2_1_Sq_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=207,file="QP_S1_t2_1_Sq_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=208,file="QP_S1_t2_1_Sq_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=209,file="QP_S1_t2_1_Sq_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=210,file="QP_S1_t2_1_Sq_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=211,file="QP_S1_t2_1_Sq_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=212,file="QP_S1_t2_1_Sq_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=213,file="QP_S1_t2_1_Sq_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=214,file="QP_S1_t2_1_Sq_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=215,file="QP_S1_t2_1_Sq_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=216,file="QP_S1_t2_1_Sq_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=217,file="QP_S1_t2_1_Sq_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=218,file="QP_S1_t2_1_Sq_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=219,file="QP_S1_t2_1_Sq_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=220,file="QP_S1_t2_1_Sq_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=221,file="QP_S1_t2_1_Sq_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=222,file="QP_S1_t2_1_Sq_min_11_u6_N20_m.txt"
c     &,status='unknown')
c
cc nq cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=301,file="QP_S1_t2_1_Nq_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=302,file="QP_S1_t2_1_Nq_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=303,file="QP_S1_t2_1_Nq_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=304,file="QP_S1_t2_1_Nq_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=305,file="QP_S1_t2_1_Nq_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=306,file="QP_S1_t2_1_Nq_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=307,file="QP_S1_t2_1_Nq_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=308,file="QP_S1_t2_1_Nq_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=309,file="QP_S1_t2_1_Nq_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=310,file="QP_S1_t2_1_Nq_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=311,file="QP_S1_t2_1_Nq_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=312,file="QP_S1_t2_1_Nq_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=313,file="QP_S1_t2_1_Nq_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=314,file="QP_S1_t2_1_Nq_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=315,file="QP_S1_t2_1_Nq_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=316,file="QP_S1_t2_1_Nq_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=317,file="QP_S1_t2_1_Nq_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=318,file="QP_S1_t2_1_Nq_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=319,file="QP_S1_t2_1_Nq_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=320,file="QP_S1_t2_1_Nq_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=321,file="QP_S1_t2_1_Nq_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=322,file="QP_S1_t2_1_Nq_min_11_u6_N20_m.txt"
c     &,status='unknown')
c
cc nk cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c      open(unit=401,file="QP_S1_t2_1_nk_max_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=402,file="QP_S1_t2_1_nk_max_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=403,file="QP_S1_t2_1_nk_max_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=404,file="QP_S1_t2_1_nk_max_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=405,file="QP_S1_t2_1_nk_max_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=406,file="QP_S1_t2_1_nk_max_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=407,file="QP_S1_t2_1_nk_max_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=408,file="QP_S1_t2_1_nk_max_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=409,file="QP_S1_t2_1_nk_max_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=410,file="QP_S1_t2_1_nk_max_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=411,file="QP_S1_t2_1_nk_max_11_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=412,file="QP_S1_t2_1_nk_min_1_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=413,file="QP_S1_t2_1_nk_min_2_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=414,file="QP_S1_t2_1_nk_min_3_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=415,file="QP_S1_t2_1_nk_min_4_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=416,file="QP_S1_t2_1_nk_min_5_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=417,file="QP_S1_t2_1_nk_min_6_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=418,file="QP_S1_t2_1_nk_min_7_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=419,file="QP_S1_t2_1_nk_min_8_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=420,file="QP_S1_t2_1_nk_min_9_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=421,file="QP_S1_t2_1_nk_min_10_u6_N20_m.txt"
c     &,status='unknown')
c      open(unit=422,file="QP_S1_t2_1_nk_min_11_u6_N20_m.txt"
c     &,status='unknown')
c ... to here when finding only real space physical quantities.
...
c ---------------------------------------------------------------
      do i=1,nn
         ...
         ipshift(i,1,4)=ldpy(ldpx(ldpx(i)))
         ipshift(i,2,4)=ldpy(ldpy(ldpx(i)))
         ipnum(4)=2
      end do
