...
* ----------------
      ...
      open(555,status='unknown',file='double_u9_m-1.txt')
      open(556,status='unknown',file='energy_u9_m-1.txt')

c      do U=1.0d0,20.1d0,2d0
      U=9.0d0
         ...
         call cg(nd,h_pt,U,q1,q2,p,w1,w2,w3,ee)

         call dd(num,nd,need,q1,ret)
         write(555,*) U,ret
...
c      write(6,*) 'success cg : ',iter,'iteration'
 ...
 10   i=i+1
      ...
      if(i.ge.200 .and.mod(count,10).eq.0) then
...
c --- 8x2 (d) ---
c      integer datint(2,8*6)
c      integer n_int
c      n_int=8*6

c      data datint/
c     & 2,3, 3,14, 14,15, 15,2, 7,8, 8,9, 9,10, 10,7, !x-direction
c     & 1,5, 5,12, 12,16, 16,1, 4,11, 11,6, 6,13, 13,4, !y-direction
c     & 1,3, 3,6, 6,10, 10,1, 2,5, 5,9, 9,13, 13,2, 
c     & 4,8, 8,12, 12,15, 15,4, 7,11, 11,14, 14,16, 16,7, 
c     & 1,2, 2,4, 4,7, 7,1, 3,5, 5,8, 8,11, 11,3, 
c     & 6,9, 9,12, 12,14, 14,6, 10,13, 13,15, 15,16, 16,10/

c --- 8x2 (c) ---
      integer datint(2,8*6)
      integer n_int
      n_int=8*6

      data datint/
     & 1,2, 2,3, 3,7, 7,8, 8,9, 9,13, 13,14, 14,1, !x-direction
     & 4,10, 10,15, 15,5, 5,11, 11,16, 16,6, 6,12, 12,4, !y-direction
     & 1,5, 5,8, 8,12, 12,1, 2,6, 6,9, 9,15, 15,2, 
     & 3,10, 10,13, 13,16, 16,3, 4,7, 7,11, 11,14, 14,4, 
     & 1,4, 4,3, 3,6,6,8, 8,11,11,13, 13,15, 15,1,
     & 2,5, 5,7, 7,10, 10,9, 9,12, 12,14, 14,16, 16,2/
...
c      data datint/
c     & 1,9, 9,10, 10,11, 11,1, 3,4, 4,5, 5,15, 15,3, !x-direction
c     & 2,7, 7,13, 13,16, 16,2, 6,12, 12,8, 8,14, 14,6, !y-direction
c     & 1,12, 12,5, 5,16, 16,1, 2,4, 4,8, 8,11, 11,2,
c     & 3,7, 7,10, 10,14, 14,3, 6,9, 9,13, 13,15, 15,6,
c     & 1,2, 2,3, 3,6, 6,1, 4,7, 7,9, 9,12, 12,4,
c     & 5,8, 8,10, 10,13, 13,5, 11,14, 14,15, 15,16, 16,11/
...
c      data datint/
c     & 1,2, 2,3, 3,4, 4,1, 9,10, 10,11, 11,12, 12,9,   !x-direction
c     & 5,13, 13,5, 6,14, 14,6, 7,15, 15,7, 8,16, 16,8, !y-direction
c     & 1,6, 6,10, 10,15, 15,3, 3,8, 8,12, 12,13, 13,1,
c     & 2,7, 7,11, 11,16, 16,4, 4,5, 5,9, 9,14, 14,2,
c     & 1,5, 5,12, 12,16, 16,3, 3,7, 7,10, 10,14, 14,1,
c     & 2,6, 6,9, 9,13, 13,4, 4,8, 8,11, 11,15, 15,2/


c --- 7x2 ---
c      integer datint(2,7*6)
c      integer n_int
c      n_int=7*6

c      data datint/
c     & 1,2, 2,5, 5,6, 6,7, 7,11, 11,12, 12,1, ! x-direction
c     & 3,9, 9,14, 14,8, 8,13, 13,4, 4,10, 10,3, ! y-direction
c     & 1,4, 4,7, 7,13, 13,2, 2,8, 8,11, 11,14,
c     & 14,5, 5,9, 9,12, 12,3, 3,6, 6,10, 10,1,
c     & 1,3, 3,5, 5,8, 8,7, 7,10, 10,12, 12,14,
c     & 14,2, 2,4, 4,6, 6,9,9,11, 11,13, 13,1/

c --- 3x2x3 ---
c      integer datint(2,6*6)
c      integer n_int
c      n_int=6*6
      
c      data datint/
c     & 1,2, 2,3, 3,1, 7,8, 8,9, 9,7, ! x-direction
c     & 4,10, 10,4, 5,11, 11,5, 6,12, 12,6, ! y-direction
c     & 1,5, 5,8, 8,12, 12,3, 3,4, 4,7, 
c     & 7,11, 11,2, 2,6, 6,9, 9,10, 10,1,
c     & 1,4, 4,9, 9,12, 12,2, 2,5, 5,7, 
c     & 7,10, 10,3, 3,6, 6,8, 8,11, 11,1/

c --- 2x2x2 ---
c      integer datint(2,4*6)
c      integer n_int
c      n_int=24

c      data datint/
c     & 1,2, 2,1, 5,6, 6,5, ! x-direction
c     & 3,7, 7,3, 4,8, 8,4, ! y-direction
c     & 1,4, 4,6, 6,7, 7,1,
c     & 3,5, 5,8, 8,2, 2,3,
c     & 1,3, 3,6, 6,8, 8,1,
c     & 2,4, 4,5, 5,7, 7,2/
